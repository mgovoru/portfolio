...
export default function About() {
  ...
  const textMe =
    'Я окончила математико-механический факультет Уральского государственного университета, но судьба увела меня по совсем другим дорогам. Не так давно меня пленил веб-дизайн — мир визуальных образов и эстетики интернета. Однако со временем я осознала, что истинное мое увлечение скрыто глубже: в механизмах, заставляющих гипертекст работать, в коде и логике, лежащих в основе современных веб-технологий. Стремясь разобраться во внутреннем устройстве веба, я завершила основной курс JS и курс по React в RSS School. Эти знания укрепили желание развиваться как разработчик. Теперь я посвящаю себя изучению тонкостей программирования, соединяя аналитический подход с творческим мышлением. Мой путь — это синтез точных наук и креативности, стремление понять суть и создавать не просто красивые, но и функциональные решения. Я верю, что сочетание моего образования и страсти к разработке позволит открыть новые возможности для роста';
    ...
    <>
      <div className='container'>
        <div className={styles.content}>
          <div className={styles.textabout} ref={outputRef}></div>
